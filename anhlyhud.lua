...
local v466 = vu32:MakeWindow({
    Title = "anhlyhud[beta] : Blox Fruits",
    SubTitle = "premium",
    SaveFolder = "anhlyhud"
})

v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://98904494244649", BackgroundTransparency = 0 },
...
v484:AddDiscordInvite({
    Name = "ko có tên (sever)",
    Description = "Join server to receive Update",
    Logo = "rbxassetid://98904494244649",
    Invite = "https://discord.gg/HkYXVSNGM"
})
